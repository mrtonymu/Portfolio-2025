    ...
    variants: {
      solid: _props => ({
        ...
        _hover: {
          ...
          boxShadow:
            '0 15px 35px rgba(56, 178, 172, 0.4), 0 5px 15px rgba(0,0,0,0.1)',
          transform: 'translateY(-3px) scale(1.02)',
        },
        _active: {
    ...
    variants: {
      ...
      card: props => ({
        ...
        _before: {
          ...
          height: '100%',
          background:
            'linear-gradient(90deg, transparent, rgba(56, 178, 172, 0.1), transparent)',
...
const fonts = {
  heading:
    "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Noto Color Emoji', 'Segoe UI Symbol'",
