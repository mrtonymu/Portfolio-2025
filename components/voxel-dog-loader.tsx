...
import { Box, Spinner, Skeleton, useColorModeValue, BoxProps } from '@chakra-ui/react'
...
export const DogContainer = forwardRef<HTMLDivElement, DogContainerProps>(({ children, ...props }, ref) => (
  <Box
    ref={ref}
    className="voxel-dog"
    m="auto"
