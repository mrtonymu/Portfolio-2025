    ...
    () => [
      {
        ...
        bgColor:
          'radial-gradient(ellipse at center, #4a5568 0%, #2d3748 30%, #1a202c 70%, #171923 100%)',
        range: [0, 10],
      },
      {
        ...
        fallback: '/images/stitch-animated.svg',
        bgColor:
          'radial-gradient(ellipse at center, #4299e1 0%, #3182ce 30%, #2c5282 70%, #1a202c 100%)',
        range: [10, 70],
      },
      {
        ...
        fallback: '/images/stitch-animated.svg',
        bgColor:
          'radial-gradient(ellipse at center, #68d391 0%, #48bb78 30%, #38a169 70%, #1a202c 100%)',
        range: [70, 99],
      },
      {
        ...
        fallback: '/images/stitch-animated.svg',
        bgColor:
          'radial-gradient(ellipse at center, #9f7aea 0%, #805ad5 30%, #6b46c1 70%, #1a202c 100%)',
        range: [99, 100],
      },
    ],
    []
          ...
          >
            ...
            >
              ...
              <Box
                ...
                overflow='hidden'
                border={{
                  base: '2px solid rgba(255, 255, 255, 0.3)',
                  md: '3px solid rgba(255, 255, 255, 0.3)',
                }}
                boxShadow={{
