   ...
   const timelineData: TimelineData[] = useMemo(() => [
    {
      ...
      company: 'Independent',
      description: 'Building custom websites and digital solutions for solo creators and business owners. Focusing on fast, functional sites without agency overhead or template limitations.',
      icon: '🚀'
    },
    {
      year: '2023',
      ...
      description: 'Diving deep into GPT integrations, prompt engineering, and blockchain applications. Experimenting with tomorrow\'s tools to solve real problems.',
      icon: '🤖'
    },
    {
      year: '2022',
      ...
      description: 'Ran my own dropshipping business, built internal tools for tracking profits, managing suppliers, and automating workflows. Learned efficiency with my own money on the line.',
      icon: '🚚'
    },
    {
      year: '2021',
